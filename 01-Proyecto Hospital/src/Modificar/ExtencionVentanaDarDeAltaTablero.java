...
public class ExtencionVentanaDarDeAltaTablero extends javax.swing.JFrame {
    
    private DataBase conexion;
    private DefaultTableModel modal;
    private DefaultTableCellRenderer renderer;
    
    public ExtencionVentanaDarDeAltaTablero() {
    ...
    public void agregarDatos(){
        ...
        if (listarInternos != null && listaPacientes != null) {
            for (int i = 0; i < listaPacientes.length; i++) {
                if (listaPacientes[i] != null) {
                    for (int j = 0; j < listarInternos.length; j++) {
                        if (listarInternos[j] != null && listaPacientes[i] != null) {
                            if (listaPacientes[i].getNumero_documento().equals(listarInternos[j].getDocumento())) {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido", "N° Documento", "Fecha Interno", "N° Camilla", "Estado"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtencionVentanaDarDeAltaTablero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExtencionVentanaDarDeAltaTablero().setVisible(true);
            }
        });
    }
